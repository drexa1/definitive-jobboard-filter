...
class JobFilter {
    ...
    isOld(numDays) {
        switch (this.daysAgoFilter) {
            case "today": return numDays > 0;  // grab only the ones posted "today"
            case "week":  return numDays > 7;  // grab posted no more than 7 days
            case "month": return numDays > 30; // grab all
